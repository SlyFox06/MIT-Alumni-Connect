...
<div class="d-flex">
    <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-nav mt-1 px-2">
            ...
            <?php if ($_SESSION['logged_account']['type'] == 'admin') { ?>
                <!-- Edit Events -->
                <li><a class="dropdown-item py-2 pe-5" href="edit_events.php">
                    <div class="circle-container me-2"><i class="bi bi-calendar-event nav-user-bi"></i></div><div class="fw-medium">Edit Events</div>
                </a></li>

                <!-- Edit Advertisements -->
                <li><a class="dropdown-item py-2 pe-5" href="edit_advertisements.php">
                    <div class="circle-container me-2"><i class="bi bi-megaphone-fill nav-user-bi"></i></div><div class="fw-medium">Edit Ads</div>
                </a></li>
