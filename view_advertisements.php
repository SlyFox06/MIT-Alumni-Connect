        ...
        <div class="container mb-5">
            ...
            <div class="container mt-3 py-3 px-4 card bg-white fw-medium <?php echo (isset($_POST['eventID']) || isset($_GET['filterStatus']) || isset($_GET['filterCategory']) || isset($_GET['search'])) ? NULL : 'slide-left' ?>">
                <form id="eventsFilterForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="GET">
                    ...
                    <a href="add_advertisement_user.php" class="btn btn-success fw-medium mb-1"><i class="bi bi-plus-circle me-1"></i>Add Advertisement</a>
                    ...
                    <div class="col mb-4 px-0 mx-0">
                        <div class="card">
                            <div class="row">
                                <!-- Image -->
                                <div class="col-auto">
                                    <div class="image-container-events"><img src="images/<?php echo htmlspecialchars($advertisement['photo']); ?>" class="img-fluid profilePictureThumbnail" alt="profile_picture"></div>
                                </div>
                                ...
                                <div class="col d-flex flex-column">
                                    ...
                                    <?php if (!empty($advertisement['button_message']) && !empty($advertisement['button_link'])) { ?>
                                        <div class="<?php echo ($advertisement['appliable'] == 1) ? 'mb-2' : 'mb-4' ?>">
                                            <a type='button' class='btn btn-outline-primary fw-medium px-4' href='<?php echo htmlspecialchars($advertisement['button_link']); ?>' target='_blank'><?php echo htmlspecialchars($advertisement['button_message']); ?><i class="bi bi-box-arrow-up-right ms-2" style="-webkit-text-stroke: 0.25px;"></i></a>
                                        </div>
                                    <?php } ?>
