    ...
    try {
        if (isset($_POST['add_gallery'])) {
            ...
            foreach ($_FILES["gallery_images"]["tmp_name"] as $key => $tmp_name) {
                ...
                // Handle thumbnail creation - ensure thumbnail_path always has a value
                ...
                $uploaded_files[] = [
                    ...
                    'thumbnail_path' => $thumbnail_path // This will always have a value
                ];
            }
            ...
            foreach ($uploaded_files as $file) {
                // Double-check thumbnail path exists
                $thumbnail = $file['thumbnail_path'] ?? $file['target_file'];
                $stmt->bind_param("iss", $event_id, $file['target_file'], $thumbnail);
